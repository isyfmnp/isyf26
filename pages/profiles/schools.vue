...
const schoolsUnordered = [
  { 'country': 'Cambodia', 'name': 'New Generation School Preah Sisowath High School' }, 
  { 'country': 'Cambodia', 'name': 'The Angkor Intellectual Academy' }, 
  { 'country': 'China', 'name': 'The Second High School Attached to Bejing Normal University' }, 
  { 'country': 'Chinese Taipei', 'name': 'Taipei First Girls High School' }, 
  { 'country': 'Chinese Taipei', 'name': 'Taipei Municipal Chien Kuo High School' }, 
  { 'country': 'Estonia', 'name': 'Tallinn Secondary School of Science' }, 
  { 'country': 'Hong Kong SAR', 'name': "Diocesan Girls' School" }, 
  { 'country': 'Indonesia', 'name': 'Center for Young Scientists' }, 
  { 'country': 'Indonesia', 'name': 'SMA Negeri 4 Denpasar High School' }, 
  { 'country': 'Laos', 'name': 'National Gifted Secondary School of Laos' }, 
  {'country':'Malaysia','name':'SMJK Chung Ling Pulau Pinang'},
  { 'country': 'Philippines', 'name': 'Philippine Science High School Main Campus' }, 
  { 'country': 'Republic of Korea', 'name': 'Korea Science Academy of KAIST' }, 
  { 'country': 'Singapore', 'name': 'Anglican High School' }, 
  { 'country': 'Singapore', 'name': "CHIJ St. Nicholas Girls' School" }, 
  { 'country': 'Singapore', 'name': 'Chung Cheng High School (Main)' }, 
  ...
  { 'country': 'Singapore', 'name': 'NUS High School of Mathematics and Science' }, 
  ...
  { 'country': 'Singapore', 'name': 'School of Science and Technology, Singapore' }, 
  { 'country': 'Singapore', 'name': "St. Margaret's School (Secondary)" }, 
  { 'country': 'Singapore', 'name': "St. Joseph's Institution (Secondary)" }, 
  { 'country': 'Singapore', 'name': 'Tanjong Katong Secondary School' }, 
  { 'country': 'Singapore', 'name': 'Temasek Junior College' }, 
  { 'country': 'Singapore', 'name': 'Yuan Ching Secondary School' }, 
  ...
  { 'country': 'Singapore', 'name': 'Jurong Secondary School' }, 
  { 'country': 'Singapore', 'name': 'Hwa Chong Institution' }, 
  { 'country': 'Thailand', 'name': 'Kamnoetvidya Science Academy' }, 
  { 'country': 'Thailand', 'name': 'Mahidol Wittayanusorn School' }, 
  { 'country': 'United States of America', 'name': 'Staples High School' }, 
  { 'country': 'Vietnam', 'name': 'HUS High School for Gifted Students' }];
